...
from roman_datamodels import nodes, stnode, validate

# from roman_datamodels import datamodels, maker_utils, stnode, validate, nodes
# from roman_datamodels.maker_utils._base import NOFN, NONUM, NOSTR
from roman_datamodels.testing import assert_node_is_copy, wraps_hashable


@pytest.mark.usefixtures("use_testing_shape")
@pytest.mark.parametrize("node_cls", stnode.RDM_NODE_REGISTRY.object_nodes.values())
def test_copy(node_cls):
    ...
    if node_cls is not nodes.DistortionRef:
