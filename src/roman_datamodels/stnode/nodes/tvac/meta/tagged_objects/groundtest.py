...
class TvacGroundtest(rad.TaggedObjectNode):
    ...
    def led_bank1_band_number_on(self) -> core.LNode[int]:
        return self._get_node("led_bank1_band_number_on", lambda: core.LNode([_default.NOINT]))

    @rad.field
    def led_bank2_bank1_number_on(self) -> core.LNode[int]:
        return self._get_node("led_bank2_bank1_number_on", lambda: core.LNode([_default.NOINT]))
