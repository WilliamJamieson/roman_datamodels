...
class Photometry(BaseDataModel):
    ...
    pixelarea_steradians: Annotated[
        AstropyQuantity[np.float64, 0, Unit("sr")] | None, Field(title="Nominal pixel area in steradians")
    ]
    pixelarea_arcsecsq: Annotated[
        AstropyQuantity[np.float64, 0, Unit("arcsec**2")] | None, Field(title="Nominal pixel area in arcsec^2")
    ]
